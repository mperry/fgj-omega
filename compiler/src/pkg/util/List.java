...
/*  42 */     }while (paramList1 != paramList2); return true;
/*     */ 
...
/*     */   {
/*  58 */     switch (1.$SwitchMap$pkg$util$List$Kind[((Kind)getKind()).ordinal()]) { case 1:
/*  59 */       return true;
/*     */     case 2:
/*  60 */       return false; }
...
/*     */   {
/*  66 */     switch (1.$SwitchMap$pkg$util$List$Kind[((Kind)getKind()).ordinal()]) { case 1:
/*  67 */       throw Debug.illegal(this, "head", new Object[0]);
/*     */     case 2:
/*  68 */       return ((Cons)this).head; }
/*  69 */     throw Debug.unexpected(this);
/*     */   }
/*     */ 
/*     */   public final List<Type> tail()
/*     */   {
/*  74 */     switch (1.$SwitchMap$pkg$util$List$Kind[((Kind)getKind()).ordinal()]) { case 1:
...
/*  88 */       switch (1.$SwitchMap$pkg$util$List$Kind[((Kind)localList.getKind()).ordinal()]) { case 1:
/*  89 */         return i;
/*     */       case 2:
/*  90 */         i++; break;
/*     */       default:
...
/*     */   {
/*  97 */     Object localObject = Nil();
/*  98 */     for (List localList = this; ; localList = localList.tail())
/*  99 */       switch (1.$SwitchMap$pkg$util$List$Kind[((Kind)localList.getKind()).ordinal()]) { case 1:
...
/* 111 */       switch (1.$SwitchMap$pkg$util$List$Kind[((Kind)localList.getKind()).ordinal()]) { case 1:
...
/*     */   {
/* 120 */     int i = paramInt;
/* 121 */     for (List localList = this; ; i--) {
/* 122 */       switch (1.$SwitchMap$pkg$util$List$Kind[((Kind)localList.getKind()).ordinal()]) { case 1:
...
/* 144 */       switch (1.$SwitchMap$pkg$util$List$Kind[((Kind)localList.getKind()).ordinal()]) { case 1:
/* 145 */         return ")";
/*     */       case 2:
